...
def GridSearch_Heatmap(scores):
    # Nota: O comando abaixo (%matplotlib notebook) gera gráficos interativos que não funcionam no GitHub.
    # Para visualizar no Markdown, altere para %matplotlib inline no Jupyter e gere novamente.
    # %matplotlib notebook
